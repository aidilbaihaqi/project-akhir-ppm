...
import 'package:shamo_frontend/widgets/primarybutton.dart';
...
class _SignInPage extends State<SignInPage> {
  ...
  Widget build(BuildContext context) {
    ...
    handleSignIn() async {
      ...
      final currentScaffoldMessenger = ScaffoldMessenger.of(currentContext);
      ...
      if (result) {
        ...
        currentNavigator.pushNamedAndRemoveUntil('/home', (Route<dynamic> route) => false);
      } else {
        currentScaffoldMessenger.showSnackBar(
          SnackBar(
